...
export const de: I18nDictionary = {
  ...
  "git.menu.title": "🔧 Git-Befehle\n\n🌿 {branch} · {sync}\n{changes}\n\nWähle eine Aktion:",
  "git.status.synced": "✅ auf dem neuesten Stand",
  "git.status.ahead_behind": "↑{ahead} ↓{behind}",
  "git.status.no_upstream": "kein Upstream",
  "git.status.clean": "✨ Arbeitsverzeichnis sauber",
  "git.status.changed_files": "📝 {count} Datei(en) geändert",
  "git.status.conflicts": "⚠️ {count} Konflikt(e)",
  "git.status.detached": "losgelöster HEAD",
  "git.button.push": "📤 Push",
  "git.push.pushing": "⏳ Wird gepusht…",
  "git.push.nothing": "✅ Nichts zu pushen — auf dem neuesten Stand",
  "git.push.detached": "⚠️ Push nicht möglich: losgelöster HEAD",
  "git.push.success": "✅ {count} Commit(s) nach origin/{branch} gepusht",
  "git.push.success_new": "✅ {branch} gepusht und Upstream auf origin/{branch} gesetzt",
  "git.push.error": "❌ Push fehlgeschlagen: {error}",
  "git.button.pull": "📥 Pull",
  "git.pull.pulling": "⏳ Wird gepullt…",
  "git.pull.nothing": "✅ Nichts zu pullen — auf dem neuesten Stand",
  "git.pull.no_upstream": "⚠️ Pull nicht möglich: kein Upstream",
  "git.pull.detached": "⚠️ Pull nicht möglich: losgelöster HEAD",
  "git.pull.success": "✅ {count} Commit(s) von origin/{branch} gepullt",
  "git.pull.error": "❌ Pull fehlgeschlagen: {error}",
  "git.button.log": "📜 Log",
  "log.menu.title": "📜 Letzte Commits ({count})\n\nWähle einen Commit, um seinen Diff anzuzeigen:",
  "log.empty": "📜 Noch keine Commits",
  "log.error": "❌ Commit-Historie konnte nicht geladen werden",
  "git.button.diff": "🔍 Diff anzeigen",
  "git.button.commit": "💾 Änderungen committen",
  "git.button.worktree": "🌿 Worktree wechseln",
  "diff.no_changes": "✅ Keine nicht committeten Änderungen",
  "diff.menu.title": "📝 Geänderte Dateien ({count})\n\nWähle eine Datei, um ihren Diff anzuzeigen:",
  "diff.button.patch": "📦 Vollständigen Patch herunterladen",
  "diff.binary_label": "binär",
  "diff.file_error": "❌ Diff konnte nicht geladen werden",
  "diff.truncated_hint": "✂️ Der Diff ist zu lang — nutze „Vollständigen Patch herunterladen“, um alles zu sehen.",
  "diff.patch_caption": "📦 Vollständiger Patch der nicht committeten Änderungen",
  "commit.no_changes": "✅ Nichts zu committen — der Worktree ist sauber",
  "commit.generating": "⏳ Commit-Nachricht wird generiert...",
  "commit.confirm_title": "💾 Alle Änderungen mit dieser Nachricht committen?\n\n{message}",
  "commit.button.confirm": "✅ Committen",
  "commit.button.regenerate": "🔁 Neu generieren",
  "commit.button.edit": "✏️ Bearbeiten",
  "commit.edit_prompt": "✏️ Sende die Commit-Nachricht als Textnachricht:",
  "commit.success": "✅ Commit {hash}: {message}",
  "commit.error": "❌ Commit fehlgeschlagen",
  "commit.generation_fallback": "⚠️ Nachricht konnte nicht über OpenCode generiert werden — Fallback wird verwendet.",
