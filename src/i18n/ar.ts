...
export const ar: I18nDictionary = {
  ...
  "git.menu.title": "🔧 أوامر Git\n\n🌿 {branch} · {sync}\n{changes}\n\nاختر إجراءً:",
  "git.status.synced": "✅ محدّث مع البعيد",
  "git.status.ahead_behind": "↑{ahead} ↓{behind}",
  "git.status.no_upstream": "لا يوجد فرع upstream",
  "git.status.clean": "✨ شجرة العمل نظيفة",
  "git.status.changed_files": "📝 {count} ملف(ات) معدّلة",
  "git.status.conflicts": "⚠️ {count} تعارض(ات)",
  "git.status.detached": "HEAD منفصل",
  "git.button.push": "📤 دفع (Push)",
  "git.push.pushing": "⏳ جارٍ الدفع…",
  "git.push.nothing": "✅ لا شيء للدفع — محدّث مع البعيد",
  "git.push.detached": "⚠️ لا يمكن الدفع: HEAD منفصل",
  "git.push.success": "✅ تم دفع {count} إيداع(ات) إلى origin/{branch}",
  "git.push.success_new": "✅ تم دفع {branch} وتعيين upstream إلى origin/{branch}",
  "git.push.error": "❌ فشل الدفع: {error}",
  "git.button.pull": "📥 سحب (Pull)",
  "git.pull.pulling": "⏳ جارٍ السحب…",
  "git.pull.nothing": "✅ لا شيء للسحب — محدّث مع البعيد",
  "git.pull.no_upstream": "⚠️ لا يمكن السحب: لا يوجد فرع upstream",
  "git.pull.detached": "⚠️ لا يمكن السحب: HEAD منفصل",
  "git.pull.success": "✅ تم سحب {count} إيداع(ات) من origin/{branch}",
  "git.pull.error": "❌ فشل السحب: {error}",
  "git.button.log": "📜 السجل",
  "log.menu.title": "📜 آخر الإيداعات ({count})\n\nاختر إيداعًا لعرض الفروقات:",
  "log.empty": "📜 لا توجد إيداعات بعد",
  "log.error": "❌ تعذر تحميل سجل الإيداعات",
  "git.button.diff": "🔍 عرض الفروقات",
  "git.button.commit": "💾 تأكيد التغييرات",
  "git.button.worktree": "🌿 تبديل نسخة العمل",
  "diff.no_changes": "✅ لا توجد تغييرات غير مؤكدة",
  "diff.menu.title": "📝 الملفات المعدلة ({count})\n\nاختر ملفًا لعرض الفروقات:",
  "diff.button.patch": "📦 تنزيل التصحيح الكامل",
  "diff.binary_label": "ثنائي",
  "diff.file_error": "❌ فشل تحميل الفروقات",
  "diff.truncated_hint": "✂️ الفروقات طويلة جدًا — استخدم «تنزيل التصحيح الكامل» لرؤية كل شيء.",
  "diff.patch_caption": "📦 التصحيح الكامل للتغييرات غير المؤكدة",
  "commit.no_changes": "✅ لا شيء للتأكيد — شجرة العمل نظيفة",
  "commit.generating": "⏳ جارٍ توليد رسالة التأكيد...",
  "commit.confirm_title": "💾 تأكيد جميع التغييرات بهذه الرسالة؟\n\n{message}",
  "commit.button.confirm": "✅ تأكيد",
  "commit.button.regenerate": "🔁 إعادة التوليد",
  "commit.button.edit": "✏️ تعديل",
  "commit.edit_prompt": "✏️ أرسل رسالة التأكيد كرسالة نصية:",
  "commit.success": "✅ تم التأكيد {hash}: {message}",
  "commit.error": "❌ فشل التأكيد",
  "commit.generation_fallback": "⚠️ تعذر توليد رسالة عبر OpenCode — سيتم استخدام رسالة بديلة.",
