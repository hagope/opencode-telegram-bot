...
export const ru: I18nDictionary = {
  ...
  "git.menu.title": "🔧 Команды Git\n\n🌿 {branch} · {sync}\n{changes}\n\nВыберите действие:",
  "git.status.synced": "✅ синхронизировано",
  "git.status.ahead_behind": "↑{ahead} ↓{behind}",
  "git.status.no_upstream": "нет upstream-ветки",
  "git.status.clean": "✨ Рабочее дерево чистое",
  "git.status.changed_files": "📝 Изменено файлов: {count}",
  "git.status.conflicts": "⚠️ Конфликтов: {count}",
  "git.status.detached": "отсоединённый HEAD",
  "git.button.push": "📤 Push",
  "git.push.pushing": "⏳ Отправка…",
  "git.push.nothing": "✅ Нечего отправлять — синхронизировано с удалённым репозиторием",
  "git.push.detached": "⚠️ Нельзя выполнить push: отсоединённый HEAD",
  "git.push.success": "✅ Отправлено коммитов: {count} в origin/{branch}",
  "git.push.success_new": "✅ Ветка {branch} отправлена, upstream установлен на origin/{branch}",
  "git.push.error": "❌ Ошибка push: {error}",
  "git.button.pull": "📥 Pull",
  "git.pull.pulling": "⏳ Получение изменений…",
  "git.pull.nothing": "✅ Нечего получать — синхронизировано с удалённым репозиторием",
  "git.pull.no_upstream": "⚠️ Нельзя выполнить pull: нет upstream-ветки",
  "git.pull.detached": "⚠️ Нельзя выполнить pull: отсоединённый HEAD",
  "git.pull.success": "✅ Получено коммитов: {count} из origin/{branch}",
  "git.pull.error": "❌ Ошибка pull: {error}",
  "git.button.log": "📜 Лог",
  "log.menu.title": "📜 Последние коммиты ({count})\n\nВыберите коммит, чтобы посмотреть diff:",
  "log.empty": "📜 Коммитов пока нет",
  "log.error": "❌ Не удалось загрузить историю коммитов",
  "git.button.diff": "🔍 Показать diff",
  "git.button.commit": "💾 Закоммитить изменения",
  "git.button.worktree": "🌿 Переключить worktree",
  "diff.no_changes": "✅ Нет незакоммиченных изменений",
  "diff.menu.title": "📝 Изменённые файлы ({count})\n\nВыберите файл, чтобы посмотреть diff:",
  "diff.button.patch": "📦 Скачать полный патч",
  "diff.binary_label": "бинарный",
  "diff.file_error": "❌ Не удалось загрузить diff",
  "diff.truncated_hint": "✂️ Diff слишком длинный — используйте «Скачать полный патч», чтобы увидеть всё.",
  "diff.patch_caption": "📦 Полный патч незакоммиченных изменений",
  "commit.no_changes": "✅ Нечего коммитить — рабочее дерево чистое",
  "commit.generating": "⏳ Генерируется сообщение коммита...",
  "commit.confirm_title": "💾 Закоммитить все изменения с этим сообщением?\n\n{message}",
  "commit.button.confirm": "✅ Закоммитить",
  "commit.button.regenerate": "🔁 Сгенерировать заново",
  "commit.button.edit": "✏️ Изменить",
  "commit.edit_prompt": "✏️ Отправьте сообщение коммита текстовым сообщением:",
  "commit.success": "✅ Коммит {hash}: {message}",
  "commit.error": "❌ Не удалось сделать коммит",
  "commit.generation_fallback": "⚠️ Не удалось сгенерировать сообщение через OpenCode — используется запасное.",
