...
export const fr: I18nDictionary = {
  ...
  "cmd.description.git": "Commandes Git",
  ...
  "git.menu.title": "🔧 Commandes Git\n\n🌿 {branch} · {sync}\n{changes}\n\nChoisissez une action :",
  "git.status.synced": "✅ à jour",
  "git.status.ahead_behind": "↑{ahead} ↓{behind}",
  "git.status.no_upstream": "pas de branche amont",
  "git.status.clean": "✨ Répertoire de travail propre",
  "git.status.changed_files": "📝 {count} fichier(s) modifié(s)",
  "git.status.conflicts": "⚠️ {count} conflit(s)",
  "git.status.detached": "HEAD détaché",
  "git.button.push": "📤 Push",
  "git.push.pushing": "⏳ Push en cours…",
  "git.push.nothing": "✅ Rien à pousser — à jour avec le distant",
  "git.push.detached": "⚠️ Push impossible : HEAD détaché",
  "git.push.success": "✅ {count} commit(s) poussé(s) vers origin/{branch}",
  "git.push.success_new": "✅ {branch} poussée et amont défini sur origin/{branch}",
  "git.push.error": "❌ Échec du push : {error}",
  "git.button.pull": "📥 Pull",
  "git.pull.pulling": "⏳ Pull en cours…",
  "git.pull.nothing": "✅ Rien à tirer — à jour avec le distant",
  "git.pull.no_upstream": "⚠️ Pull impossible : pas de branche amont",
  "git.pull.detached": "⚠️ Pull impossible : HEAD détaché",
  "git.pull.success": "✅ {count} commit(s) tiré(s) depuis origin/{branch}",
  "git.pull.error": "❌ Échec du pull : {error}",
  "git.button.log": "📜 Log",
  "log.menu.title": "📜 Commits récents ({count})\n\nSélectionnez un commit pour voir son diff :",
  "log.empty": "📜 Aucun commit pour l'instant",
  "log.error": "❌ Impossible de charger l'historique des commits",
  "git.button.diff": "🔍 Afficher le diff",
  "git.button.commit": "💾 Commiter les modifications",
  "git.button.worktree": "🌿 Changer de worktree",
  "diff.no_changes": "✅ Aucune modification non commitée",
  "diff.menu.title": "📝 Fichiers modifiés ({count})\n\nSélectionnez un fichier pour voir son diff :",
  "diff.button.patch": "📦 Télécharger le patch complet",
  "diff.binary_label": "binaire",
  "diff.file_error": "❌ Impossible de charger le diff",
  "diff.truncated_hint": "✂️ Le diff est trop long — utilisez « Télécharger le patch complet » pour tout voir.",
  "diff.patch_caption": "📦 Patch complet des modifications non commitées",
  "commit.no_changes": "✅ Rien à commiter — l'arbre de travail est propre",
  "commit.generating": "⏳ Génération du message de commit...",
  "commit.confirm_title": "💾 Commiter toutes les modifications avec ce message ?\n\n{message}",
  "commit.button.confirm": "✅ Commiter",
  "commit.button.regenerate": "🔁 Régénérer",
  "commit.button.edit": "✏️ Modifier",
  "commit.edit_prompt": "✏️ Envoyez le message de commit sous forme de message texte :",
  "commit.success": "✅ Commit {hash} : {message}",
  "commit.error": "❌ Échec du commit",
  "commit.generation_fallback": "⚠️ Impossible de générer un message via OpenCode — message de repli utilisé.",
