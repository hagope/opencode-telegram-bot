...
export const zh: I18nDictionary = {
  ...
  "git.menu.title": "🔧 Git 命令\n\n🌿 {branch} · {sync}\n{changes}\n\n选择一个操作：",
  "git.status.synced": "✅ 与远程同步",
  "git.status.ahead_behind": "↑{ahead} ↓{behind}",
  "git.status.no_upstream": "无上游分支",
  "git.status.clean": "✨ 工作区干净",
  "git.status.changed_files": "📝 {count} 个文件已更改",
  "git.status.conflicts": "⚠️ {count} 个冲突",
  "git.status.detached": "游离 HEAD",
  "git.button.push": "📤 推送",
  "git.push.pushing": "⏳ 正在推送…",
  "git.push.nothing": "✅ 无需推送 — 与远程同步",
  "git.push.detached": "⚠️ 无法推送：游离 HEAD",
  "git.push.success": "✅ 已推送 {count} 个提交到 origin/{branch}",
  "git.push.success_new": "✅ 已推送 {branch} 并将上游设置为 origin/{branch}",
  "git.push.error": "❌ 推送失败：{error}",
  "git.button.pull": "📥 拉取",
  "git.pull.pulling": "⏳ 正在拉取…",
  "git.pull.nothing": "✅ 无需拉取 — 与远程同步",
  "git.pull.no_upstream": "⚠️ 无法拉取：无上游分支",
  "git.pull.detached": "⚠️ 无法拉取：游离 HEAD",
  "git.pull.success": "✅ 已从 origin/{branch} 拉取 {count} 个提交",
  "git.pull.error": "❌ 拉取失败：{error}",
  "git.button.log": "📜 日志",
  "log.menu.title": "📜 最近的提交（{count}）\n\n选择一个提交查看其差异：",
  "log.empty": "📜 暂无提交",
  "log.error": "❌ 无法加载提交历史",
  "git.button.diff": "🔍 查看差异",
  "git.button.commit": "💾 提交更改",
  "git.button.worktree": "🌿 切换 worktree",
  "diff.no_changes": "✅ 没有未提交的更改",
  "diff.menu.title": "📝 已更改的文件（{count}）\n\n选择一个文件查看其差异：",
  "diff.button.patch": "📦 下载完整补丁",
  "diff.binary_label": "二进制",
  "diff.file_error": "❌ 加载差异失败",
  "diff.truncated_hint": "✂️ 差异太长 — 请使用“下载完整补丁”查看全部内容。",
  "diff.patch_caption": "📦 未提交更改的完整补丁",
  "commit.no_changes": "✅ 没有可提交的内容 — 工作树是干净的",
  "commit.generating": "⏳ 正在生成提交信息...",
  "commit.confirm_title": "💾 使用此信息提交所有更改？\n\n{message}",
  "commit.button.confirm": "✅ 提交",
  "commit.button.regenerate": "🔁 重新生成",
  "commit.button.edit": "✏️ 编辑",
  "commit.edit_prompt": "✏️ 请以文本消息形式发送提交信息：",
  "commit.success": "✅ 已提交 {hash}：{message}",
  "commit.error": "❌ 提交失败",
  "commit.generation_fallback": "⚠️ 无法通过 OpenCode 生成信息 — 使用了备用信息。",
