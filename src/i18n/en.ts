export const en = {
  ...
  "git.menu.title": "🔧 Git commands\n\n🌿 {branch} · {sync}\n{changes}\n\nChoose an action:",
  "git.status.synced": "✅ up to date",
  "git.status.ahead_behind": "↑{ahead} ↓{behind}",
  "git.status.no_upstream": "no upstream",
  "git.status.clean": "✨ Working tree clean",
  "git.status.changed_files": "📝 {count} file(s) changed",
  "git.status.conflicts": "⚠️ {count} conflict(s)",
  "git.status.detached": "detached HEAD",
  "git.button.push": "📤 Push",
  "git.push.pushing": "⏳ Pushing…",
  "git.push.nothing": "✅ Nothing to push — up to date with remote",
  "git.push.detached": "⚠️ Cannot push: detached HEAD",
  "git.push.success": "✅ Pushed {count} commit(s) to origin/{branch}",
  "git.push.success_new": "✅ Pushed {branch} and set upstream to origin/{branch}",
  "git.push.error": "❌ Push failed: {error}",
  "git.button.pull": "📥 Pull",
  "git.pull.pulling": "⏳ Pulling…",
  "git.pull.nothing": "✅ Nothing to pull — up to date with remote",
  "git.pull.no_upstream": "⚠️ Cannot pull: no upstream branch",
  "git.pull.detached": "⚠️ Cannot pull: detached HEAD",
  "git.pull.success": "✅ Pulled {count} commit(s) from origin/{branch}",
  "git.pull.error": "❌ Pull failed: {error}",
  "git.button.log": "📜 Log",
  "log.menu.title": "📜 Recent commits ({count})\n\nSelect a commit to view its diff:",
  "log.empty": "📜 No commits yet",
  "log.error": "❌ Could not load commit history",
  "git.button.diff": "🔍 Show diff",
  "git.button.commit": "💾 Commit changes",
  "git.button.worktree": "🌿 Switch worktree",
  "diff.no_changes": "✅ No uncommitted changes",
  "diff.menu.title": "📝 Changed files ({count})\n\nSelect a file to view its diff:",
  "diff.button.patch": "📦 Download full patch",
  "diff.binary_label": "binary",
  "diff.file_error": "❌ Failed to load diff",
  "diff.truncated_hint": "✂️ Diff is too long — use “Download full patch” to see everything.",
  "diff.patch_caption": "📦 Full patch of uncommitted changes",
  "commit.no_changes": "✅ Nothing to commit — the worktree is clean",
  "commit.generating": "⏳ Generating commit message...",
  "commit.confirm_title": "💾 Commit all changes with this message?\n\n{message}",
  "commit.button.confirm": "✅ Commit",
  "commit.button.regenerate": "🔁 Regenerate",
  "commit.button.edit": "✏️ Edit",
  "commit.edit_prompt": "✏️ Send the commit message as a text message:",
  "commit.success": "✅ Committed {hash}: {message}",
  "commit.error": "❌ Commit failed",
  "commit.generation_fallback": "⚠️ Could not generate a message via OpenCode — using a fallback.",
