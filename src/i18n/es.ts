...
export const es: I18nDictionary = {
  ...
  "git.menu.title": "🔧 Comandos Git\n\n🌿 {branch} · {sync}\n{changes}\n\nElige una acción:",
  "git.status.synced": "✅ al día",
  "git.status.ahead_behind": "↑{ahead} ↓{behind}",
  "git.status.no_upstream": "sin rama upstream",
  "git.status.clean": "✨ Árbol de trabajo limpio",
  "git.status.changed_files": "📝 {count} archivo(s) modificado(s)",
  "git.status.conflicts": "⚠️ {count} conflicto(s)",
  "git.status.detached": "HEAD separado",
  "git.button.push": "📤 Push",
  "git.push.pushing": "⏳ Haciendo push…",
  "git.push.nothing": "✅ Nada que enviar — al día con el remoto",
  "git.push.detached": "⚠️ No se puede hacer push: HEAD separado",
  "git.push.success": "✅ {count} commit(s) enviados a origin/{branch}",
  "git.push.success_new": "✅ {branch} enviada y upstream configurado en origin/{branch}",
  "git.push.error": "❌ Error en el push: {error}",
  "git.button.pull": "📥 Pull",
  "git.pull.pulling": "⏳ Haciendo pull…",
  "git.pull.nothing": "✅ Nada que traer — al día con el remoto",
  "git.pull.no_upstream": "⚠️ No se puede hacer pull: sin rama upstream",
  "git.pull.detached": "⚠️ No se puede hacer pull: HEAD separado",
  "git.pull.success": "✅ {count} commit(s) traídos desde origin/{branch}",
  "git.pull.error": "❌ Error en el pull: {error}",
  "git.button.log": "📜 Log",
  "log.menu.title": "📜 Commits recientes ({count})\n\nSelecciona un commit para ver su diff:",
  "log.empty": "📜 Aún no hay commits",
  "log.error": "❌ No se pudo cargar el historial de commits",
  "git.button.diff": "🔍 Ver diff",
  "git.button.commit": "💾 Confirmar cambios",
  "git.button.worktree": "🌿 Cambiar worktree",
  "diff.no_changes": "✅ No hay cambios sin confirmar",
  "diff.menu.title": "📝 Archivos modificados ({count})\n\nSelecciona un archivo para ver su diff:",
  "diff.button.patch": "📦 Descargar parche completo",
  "diff.binary_label": "binario",
  "diff.file_error": "❌ No se pudo cargar el diff",
  "diff.truncated_hint": "✂️ El diff es demasiado largo — usa «Descargar parche completo» para verlo todo.",
  "diff.patch_caption": "📦 Parche completo de los cambios sin confirmar",
  "commit.no_changes": "✅ Nada que confirmar — el árbol de trabajo está limpio",
  "commit.generating": "⏳ Generando mensaje de commit...",
  "commit.confirm_title": "💾 ¿Confirmar todos los cambios con este mensaje?\n\n{message}",
  "commit.button.confirm": "✅ Confirmar",
  "commit.button.regenerate": "🔁 Regenerar",
  "commit.button.edit": "✏️ Editar",
  "commit.edit_prompt": "✏️ Envía el mensaje de commit como un mensaje de texto:",
  "commit.success": "✅ Commit {hash}: {message}",
  "commit.error": "❌ El commit falló",
  "commit.generation_fallback": "⚠️ No se pudo generar un mensaje con OpenCode — se usa uno alternativo.",
